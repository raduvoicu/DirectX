...
LPCTSTR WndClassName = LPCTSTR(L"firstwindow");
HWND hwnd = NULL;
HRESULT hr;
    ...
    int nShowCmd)
{
    ...
    {
        MessageBox(0, LPCSTR(L"Window Initialization - Failed"),
    ...
    {
        MessageBox(0, LPCSTR(L"Scene Initialization - Failed"),
            LPCSTR(L"Error"), MB_OK);
        return 0;
    }
    ...
    bool windowed)
{
    ...
    {
        MessageBox(NULL, LPCSTR(L"Error registering class"),
            LPCSTR(L"Error"), MB_OK | MB_ICONERROR);
        return 1;
    }
    ...
    hwnd = CreateWindowEx(
        NULL,
        WndClassName,
        LPCSTR(L"Lesson 4 - Begin Drawing"),
        WS_OVERLAPPEDWINDOW,
    ...
    if (!hwnd)
    {
        MessageBox(NULL, LPCSTR(L"Error creating window"),
            LPCSTR(L"Error"), MB_OK | MB_ICONERROR);
        return 1;
    }
...
bool InitScene()
{
    ...
    hr = D3DX11CompileFromFile(LPCSTR(L"Effects.fx"), 0, 0, "VS", "vs_4_0", 0, 0, 0, &VS_Buffer, 0, 0);
    hr = D3DX11CompileFromFile(LPCSTR(L"Effects.fx"), 0, 0, "PS", "ps_4_0", 0, 0, 0, &PS_Buffer, 0, 0);
    hr = D3DX11CompileFromFile(LPCSTR(L"Effects.fx"), 0, 0, "D2D_PS", "ps_4_0", 0, 0, 0, &D2D_PS_Buffer, 0, 0);
    ///////////////**************new**************////////////////////
    hr = D3DX11CompileFromFile(LPCSTR(L"Effects.fx"), 0, 0, "SKYMAP_VS", "vs_4_0", 0, 0, 0, &SKYMAP_VS_Buffer, 0, 0);
    hr = D3DX11CompileFromFile(LPCSTR(L"Effects.fx"), 0, 0, "SKYMAP_PS", "ps_4_0", 0, 0, 0, &SKYMAP_PS_Buffer, 0, 0);
    ///////////////**************new**************////////////////////
    ...
    hr = D3DX11CreateShaderResourceViewFromFile(d3d11Device, LPCSTR(L"grass.jpg"),
    ...
    hr = D3DX11CreateTextureFromFile(d3d11Device, LPCSTR(L"skymap.dds"),
